...
const Sidebar = () => {
    ...
    const analyticsIcon =
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="18" className={`${pathname === "/analytics" ? "stroke-[#8915E4] fill-[#8915E4]" : "stroke-[#D5D5D5] fill-[#D5D5D5]"}`}>
    ...
    const insightsIcon =
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" className={`${pathname === "/insights" ? "stroke-[#8915E4] fill-[#8915E4]" : "stroke-[#D5D5D5] fill-[#D5D5D5]"} fill-none`}>
