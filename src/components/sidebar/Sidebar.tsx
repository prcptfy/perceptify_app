...
const Sidebar = () => {
    ...
    const analyticsIcon =
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="18" className={`${pathname === "/analytics" ? "fill-[#8915E4]" : "fill-[#D5D5D5]"} stroke-none`}>
            <path  fill-rule="evenodd" d="M13.562 18c-.074 0-.15-.003-.226-.011-.968-.098-1.727-.797-1.936-1.78L8.45 2.268 5.41 9.446a1.102 1.102 0 0 1-1.01.679H1.1C.492 10.126 0 9.622 0 9c0-.622.492-1.125 1.1-1.125h2.578l2.757-6.512C6.825.446 7.685-.088 8.664.012c.968.098 1.727.796 1.936 1.78l2.95 13.94 3.04-7.179a1.1 1.1 0 0 1 1.01-.677h3.3c.608 0 1.1.503 1.1 1.125 0 .62-.492 1.125-1.1 1.125h-2.578l-2.757 6.51c-.36.848-1.13 1.364-2.003 1.364Z" clip-rule="evenodd"/>
        </svg>
    ...
    const logoutIcon =
        <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
            <path d="m10.982 10.74 3.02-3.12L10.98 4.5M14.002 7.62h-9.36" stroke="#DB4437" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><mask id="a" fill="#fff"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.363.34 2.56.344a2.082 2.082 0 0 0-2.08 2.08v10.395a2.08 2.08 0 0 0 2.08 2.08h7.802"/></mask><path d="M10.363 1.94a1.6 1.6 0 0 0 0-3.2v3.2ZM2.561.344v-1.6H2.56l.001 1.6Zm-2.08 2.08h-1.6 1.6Zm9.882 14.075a1.6 1.6 0 0 0 0-3.2v3.2Zm0-17.757-7.802.002v3.2l7.802-.002v-3.2Zm-7.803.002a3.682 3.682 0 0 0-3.679 3.68l3.2.001c0-.265.216-.481.482-.481l-.003-3.2Zm-3.679 3.68v10.395h3.2V2.424h-3.2Zm0 10.395a3.68 3.68 0 0 0 3.68 3.68v-3.2a.48.48 0 0 1-.48-.48h-3.2Zm3.68 3.68h7.802v-3.2H2.56v3.2Z" fill="#DB4437" mask="url(#a)"/>
        </svg>
